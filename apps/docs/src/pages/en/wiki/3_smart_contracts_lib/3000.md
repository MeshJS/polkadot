...
```mermaid
graph TD
    D["👋 <b style='color:#4CAF50;opacity:0.5;'>Hello World<br><small style='color:red;'>(Coming Soon)</small></b><br><span style='opacity:0.5;'>Simple lock and unlock assets contract</span>"]
    ...
    %% D intentionally has no click binding
